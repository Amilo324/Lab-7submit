...
SuperCoin.prototype.type = 'supercoin';
...
// A Player has a size, speed and position. Also, a Starting position. 
function Player(pos) {
	this.initialPos = pos.plus(new Vector(0, -0.5));
...
SuperCoin.prototype.act = function(step) {
	this.wobble += step * wobbleSpeed
	var wobblePos = Math.sin(this.wobble) * wobbleDist;
	this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
